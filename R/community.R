...
#' otherwise. \eqn{gamma} is the resolution parameter.
#'
#' The resolution parameter \eqn{gamma} allows weighting the random null model, which
...
#' Set it to 1 (default) to use the classical definition of modularity.
...
#' 
#' The resolution parameter allows finding communities at different
...
#' \code{resolution=1}. Note that the returned modularity value is calculated using
#' the indicated resolution parameter. See \code{\link{modularity}} for more details.
#' 
...
#' smaller communities. Set it to 1 (default) to use the classical definition of modularity.
